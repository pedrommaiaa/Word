...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func createMenuBar() -> NSMenu {
        ...
        appMenu.addItem(NSMenuItem(title: "About WordClone", action: #selector(showAbout), keyEquivalent: ""))
        appMenu.addItem(NSMenuItem.separator())
        appMenu.addItem(NSMenuItem(title: "Preferences...", action: #selector(showPreferences), keyEquivalent: ","))
        appMenu.addItem(NSMenuItem.separator())
        appMenu.addItem(NSMenuItem(title: "Hide WordClone", action: #selector(NSApplication.hide(_:)), keyEquivalent: "h"))
        let hideOthersItem = NSMenuItem(title: "Hide Others", action: #selector(NSApplication.hideOtherApplications(_:)), keyEquivalent: "h")
        hideOthersItem.keyEquivalentModifierMask = [.command, .option]
        appMenu.addItem(hideOthersItem)
        appMenu.addItem(NSMenuItem(title: "Show All", action: #selector(NSApplication.unhideAllApplications(_:)), keyEquivalent: ""))
        appMenu.addItem(NSMenuItem.separator())
        appMenu.addItem(NSMenuItem(title: "Quit WordClone", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
        ...
        fileMenu.addItem(NSMenuItem(title: "New", action: #selector(DocumentController.newDocument(_:)), keyEquivalent: "n"))
        fileMenu.addItem(NSMenuItem(title: "Open...", action: #selector(DocumentController.openDocument(_:)), keyEquivalent: "o"))
        ...
        helpMenu.addItem(NSMenuItem(title: "WordClone Help", action: #selector(showHelp), keyEquivalent: "?"))
